...
import { TrashBox } from "../documents/TrashBox";
import UserItem from "../documents/UserItem";
import {Navigation as AppNavigation} from "./Navigation";
...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      >
        {params.documentId ? (
          <AppNavigation isCollapsed={isCollapsed} onResetWidth={resetWidth} />
        ) : (
